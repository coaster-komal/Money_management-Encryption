...
public class View_montly extends ActionBarActivity {
    DBHelpertrans mydb;
    DBHelper md;
    ListView lv;
    TextView t,t1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_montly);
        ...
        t1.setText(s2);
        System.out.println("INCOME=" + s2);
        try {

            Cursor rs = mydb.viewtransactionmonthly(s, d);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_view_montly, menu);
        return true;
    }
